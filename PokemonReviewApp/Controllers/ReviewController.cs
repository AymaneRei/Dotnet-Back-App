...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public IActionResult GetReviews(long reviewId)
        {
        ...
        [ProducesResponseType(400)]
        public IActionResult GetReviewsForAPokemon(long pokemonId)
        {
        ...
        [ProducesResponseType(400)]
        public IActionResult CreateReview([FromQuery] long reviewerId, [FromQuery] long pokemonId, [FromBody] ReviewDto reviewCreate)
        {
        ...
        public IActionResult UpdateReview(long reviewId, [FromBody] ReviewDto updatedReview)
        {
        ...
        [ProducesResponseType(204)]
        [ProducesResponseType(404)]
        public IActionResult DeleteReviewsByReviewer(long reviewerId)
        {
